    ...
    <header class="hero-header">
      ...
      <div class="header-inner">
        ...
        >
          ...
          <span class="brand-name">Luxury Estate</span>
        </a>
...
.header-inner {
  ...
  min-height: clamp(84px, 9vh, 104px);
  margin: 0 auto;
...
@media (max-width: 900px) {
  ...
  /* =========================================================
   SEARCH BUTTON — FULL BLACK, NO WHITE SPACE
========================================================= */
